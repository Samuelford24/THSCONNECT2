...
public class admin_adapter_add_class_to_user extends RecyclerView.Adapter<admin_adapter_add_class_to_user.MyHolder>{

    List<Class_model> listdata;

    public admin_adapter_add_class_to_user(List<Class_model> listdata) {
        this.listdata = listdata;
    }

    @Override
    public admin_adapter_add_class_to_user.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_class_model,parent,false);

        admin_adapter_add_class_to_user.MyHolder myHolder = new admin_adapter_add_class_to_user.MyHolder(view);
        return myHolder;
    }
